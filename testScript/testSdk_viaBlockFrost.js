...
const apiKey = process.env.AdaApiKey ? process.env.AdaApiKey : "previewxyYfc34VvkWPHZd3rkFvu7ct9fJb8g7r";

let g_client = new CardanoClient();
g_client.init(false, {isTestNet: true, projectId: apiKey});
...
async function main(){
	...
	let plutusTxSrvInst = new plutusTxService(g_client, scriptRefOwnerAddr, console);
