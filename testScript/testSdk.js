...
async function main(){
	...
	{
		const scAddress = plutusTxSrvInst.getLockerScAddress();
		console.log("scAddress: ", scAddress);
	}

	{
		let refUtxos = await plutusTxSrvInst.getScriptRefUtxo();
		console.log("refUtxos:", refUtxos);
	}
	// {
	// 	const proofInfo = {
	...
	{
		let redeemerCbor = "";

		let redeemerData = await contracts.TreasuryScript.getRedeemerFromCBOR(redeemerCbor);
		console.log("redeemer from cbor:", redeemerData);
	}
